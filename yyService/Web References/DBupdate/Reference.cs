...
namespace yyService.DBupdate {
    ...
    public partial class DBupdateService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public DBupdateService() {
            this.Url = global::yyService.Properties.Settings.Default.yyService_DBupdate_DBupdateService;
        ...
        public int test(int bRdFlag, double iQuantity, int inAutoID, double canOutQuantity) {
        ...
        /// <remarks/>
        public void testAsync(int bRdFlag, double iQuantity, int inAutoID, double canOutQuantity) {
            this.testAsync(bRdFlag, iQuantity, inAutoID, canOutQuantity, null);
        }
        
        /// <remarks/>
        public void testAsync(int bRdFlag, double iQuantity, int inAutoID, double canOutQuantity, object userState) {
            ...
            this.InvokeAsync("test", new object[] {
                        ...
                        iQuantity,
                        inAutoID,
                        canOutQuantity}, this.testOperationCompleted, userState);
        }
